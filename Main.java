...
public class Main implements ActionListener{
	...
	private void initialize() {
		...
		Label WeatherLabel = new Label("Outside Temp:");
		...
		Label label = new Label("Aircond Temp");
		label.setBounds(10, 222, 110, 22);
		frame.getContentPane().add(label);
		
		weatherList = new List();
		weatherList.setEnabled(false);
		weatherList.setBounds(290, 250, 110, 60);
		frame.getContentPane().add(weatherList);
		
		Label label_1 = new Label("Weather Temp");
		label_1.setBounds(291, 222, 110, 22);
		...
		coldnessList.setBounds(145, 250, 110, 60);
		frame.getContentPane().add(coldnessList);
		
		Label label_2 = new Label("Coldness");
		label_2.setBounds(145, 222, 110, 22);
		...
		weatherTempList.add("Hot Temp: 29 < x <= 33");
		...
		weatherChoice.add("Cloudy & Hot");
		weatherChoice.add("Hot");
